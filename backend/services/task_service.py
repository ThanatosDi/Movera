...
from backend.exceptions.task_exception import (
    TaskAlreadyExists,
    TaskNotFound,
)
...
class TaskService:
    """CRUD operations and business rules for Task entities.

    Why: Encapsulates task-specific validation (e.g. duplicate name checks)
    so that routers stay thin and rules are testable in isolation.
    """
