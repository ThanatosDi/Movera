    ...
    <div class="bg-gray-800 rounded-md p-3 mb-3 space-y-3">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1">
          <Select
            ...
            @update:model-value="toggleTagFilter"
          >
            ...
            <SelectContent class="bg-gray-700 border-gray-600">
              <SelectItem
                ...
                :class="[
                  ...
                  selectedTags.includes(tag) ? 'bg-green-600 text-white' : ''
                ]"
              >
                <div class="flex items-center justify-between w-full">
                  ...
                  <span
                    ...
                    class="text-xs opacity-75 right-2 absolute"
                  >✓</span>
                </div>
              </SelectItem>
            </SelectContent>
      ...
      >
        <Badge
          ...
          :key="tag"
          variant="secondary"
          class="bg-green-600 text-white text-xs flex items-center gap-1"
        >
          {{ tag }}
          <button
            @click="removeTagFilter(tag)"
            class="hover:bg-green-700 rounded-full p-0.5"
            type="button"
          >
            <X class="w-3 h-3" />
          </button>
